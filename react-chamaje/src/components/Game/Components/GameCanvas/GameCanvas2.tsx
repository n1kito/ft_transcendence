...
const GameCanvas: React.FC = () => {
	// Import the gameContext and gameSocket
	// const {} = useGameSocket();
	...
	useEffect(() => {
		...
		return () => {
			// TODO: remove event listeners from the window or element,
			// otherwise we might introduce bugs
	...
	return (
		<canvas className="game-canvas" ref={canvasRef} width={700} height={500}>
